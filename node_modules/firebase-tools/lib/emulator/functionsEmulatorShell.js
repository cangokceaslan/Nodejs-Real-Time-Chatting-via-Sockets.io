    ...
    constructor(emu) {
        ...
        for (const trigger of this.triggers) {
            ...
            if (trigger.httpsTrigger) {
                this.urls[name] = functionsEmulator_1.FunctionsEmulator.getHttpFunctionUrl(this.emu.getInfo().host, this.emu.getInfo().port, this.emu.projectId, name, functionsEmulatorShared_1.getFunctionRegion(trigger));
            }
        }
    }
    call(name, data, opts) {
        ...
        functionsEmulator_1.FunctionsEmulator.startFunctionRuntime(this.emu.getBaseBundle(), name, this.emu.nodeBinary, proto);
    }
    getTrigger(name) {
