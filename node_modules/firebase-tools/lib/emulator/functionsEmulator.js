        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const loadTriggers = () => __awaiter(this, void 0, void 0, function* () {
                ...
                for (const result of successTriggers) {
                    ...
                    emulatorLogger_1.EmulatorLogger.logLabeled("SUCCESS", "functions", msg);
                }
                const ignoreTriggers = triggerResults.filter((r) => r.ignored);
                for (const result of ignoreTriggers) {
                    const msg = `Function ${clc.bold(result.name)} ignored because the emulator for ${result.type} does not exist or is not running.`;
                    emulatorLogger_1.EmulatorLogger.logLabeled("BULLET", "functions", msg);
                }
            });
